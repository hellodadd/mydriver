...
public class ProgressWheel extends View {
    ...
    //Colors (with defaults) all is transparent 
    private int barColor = 0x00FFFFFF;//进度条的颜色
    private int contourColor = 0x00FFFFFF;
    private int circleColor = 0x00FFFFFF;
    private int rimColor = 0x00DDDDDD;
    ...
    public float oneMinuteStep = 0.6f;//以一分钟为标准，每100ms应该走的度数
    ...
    */
    ...
    /**
     * Increment the progress by step (of 360)
     */
    public void incrementProgress(float step) {
        isSpinning = false;
...
//        setText(Math.round(((float) progress / 360) * 100) + "%");
    ...
    //计算在time时间内，每100ms要转的度数
    public  float getProgressEveryStep(float time){
        return oneMinuteStep/time;
    }
